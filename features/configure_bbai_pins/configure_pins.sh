...
while read PIN DIR JUNK ; do
	...
	75	out	# P8.11		gpio3.11	B Dir
	74	out	# P8.12		gpio3.10	B Step
	107	out	# P8.13		gpio4.11	Spindle PWM
	109	in	# P8.14		gpio4.13	Y Limit
	99	out	# P8.15		gpio4.3 	Z Dir
	125	out	# P8.16		gpio4.29	Z Step
	...
	76	out	# p9.15		gpio3.12	Y Dir
	122	in	# p9.16		gpio4.26	A Limit
	209	in	# p9.17		gpio7.17	Unused
	67	in	# p9.21		gpio3.3		Interlock
	179	in	# p9.22		gpio6.19	Probe Signal
	203	out	# p9.23		gpio7.11	Y Step
	175	out	# P9.24		gpio6.15	Spindle On
	111	out	# P9.27		gpio4.15	X Step
	113	out	# P9.28		gpio4.17	A Dir
	139	out	# p9.29		gpio5.11        X Dir
	140	out	# p9.30		gpio5.12	A Step
EOF
